...
for rounds in [200, 500, 600, 700]:
    ...
    print(f"num_boost_round: {rounds} -> Train: {train_dev:.4f} | Test: {test_dev:.4f} | Gap: {gap:.4f}")
...
train_dev = mean_poisson_deviance(y_train, best_model.predict(X_train))
